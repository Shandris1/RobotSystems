...
[returnedBot, particles, mean_pos mean_ang] = localise_final3_real90D(botSim,mean_particle,chosen_particles,particles,map,target,readings, Noise_level,num,0,max_dim,[],[],[],0,stepsize,adjacency,reduced,dist); %Where the magic happens
...
[returnedBot, particles, mean_pos mean_ang] = localise_final3_real90D(botSim,returnedBot,chosen_particles,final_particles,map,target,readings, Noise_level,num,1,max_dim,moveCmd,turnCmd,optimal,1,stepsize,adjacency,reduced,dist);
