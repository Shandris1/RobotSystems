function [mean_particle, particles, mean_pos mean_ang , botScan] = localise_final3_real(botSim,mean_particle,chosen_particles,particles,map,target,readings, noiselevel,num,path_plan,max_dim_vec,moveCmd,turnCmd,optimal,localise,stepsize,adjacency,reduced,path_dist, botScan)
