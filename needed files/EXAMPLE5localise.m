...
map = [-30,0;-30,40;30,40;30,60;5,60;45,90;85,60;60,60;60,40;120,40;120,60;95,60;135,90;175,60;150,60;150,40;210,40;210,60;185,60;225,90;265,60;240,60;240,40;300,40;300,0];
 ...
 botSim = BotSim(map,[9,0.005,0]);  %sets up a botSim object a map, and debug mode on.
...
[returnedBot pos ang] = localise_final3(botSim,map,target,readings, Noise_level); %Where the magic happens
%close_array = map_obstacle(map,1,1);
resultsTime = toc
resultsDis =  distance(returnedBot.getBotPos(), botSim.getBotPos())

out = visbil_full(map,botSim,target);
adjacency = visbil_point(map,target,out);
[move turn optimal] = Astar_visbil(pos,ang, adjacency,map,botSim)
